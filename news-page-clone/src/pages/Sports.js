...
import data from "../data/sportaData";
...
function Sports(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://newsapi.org/v2/top-headlines?apiKey=${props.API_KEY}&pageSize=20&category=sports&country=us`
      )
      .then((response) => {
        setArticles(
  ...
  return (
    <section>
      <h1 className="Articles__title">Sports</h1>
