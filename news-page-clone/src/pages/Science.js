...
import data from "../data/scienceData";
...
function Science(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://newsapi.org/v2/top-headlines?apiKey=${props.API_KEY}&pageSize=20&category=science&country=us`
      )
      .then((response) => {
        setArticles(
  ...
  return (
    <section>
      <h1 className="Articles__title">Science</h1>
